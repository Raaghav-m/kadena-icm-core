import type { ICommand, ICommandResult, ChainId } from '@kadena/client';
import {
  Pact,
  createClient,
  isSignedTransaction,
...
import { createRequestToSign } from './requestToSign';
...
export default async function writeMessage({
  ...
  try {
    ...
    // ask the user for a signature using our requestToSign helper
